...
def drawing():
	...
	ranR = random.randint(0,255)
	ranG = random.randint(0,255)
	ranB = random.randint(0,255)
...
#Text and Box
	...
	text = Text(Point(250,20),randomData)
	text.draw(window)


	#Face
	face = Circle(Point(250,250), 100)
	face.setFill(color_rgb(ranR,ranG,ranB))
	face.setWidth(2)
	face.draw(window)
	...
	eye2.setFill(color_rgb(255,255,255))
	eye2.setWidth(2)
	eye2.draw(window)
